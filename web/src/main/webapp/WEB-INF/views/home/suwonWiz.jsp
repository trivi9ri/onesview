...
<body class style="overflow: visible;" id="body">
...
<div class="container-fluid">
    ...
    <div class="subcontents_wrap">
        ...
        <div class="container main-container clearfix" style="padding: 0 15px 100px 15px; margin: 0 auto">
            ...
            <div class="col-md-pull-12">
                ...
                <img id = "ktwiz" src="<%=cp%>../../../img/kt_wiz.jpg" width="900" height="587" usemap="#ktmap" alt="" style="margin: auto">
                <map name="ktmap">
