...
<main>
    ...
    <section id = "content1">
        ...
        <map name = "Area212">
            <area id="ri212f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="212f" data-toggle="modal" onclick="getId('ri212f')">
            <area id="212m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="212m" data-toggle="modal" onclick="getId('ri212m')">
