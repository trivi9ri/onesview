...
<main>
    ...
    <section id="content4">
        ...
        <h5 class="centered" style="color: grey">126구역은 화살표가 가르치는 출구를 통해 나가셔서 2층 화장실을 이용하시기를 추천합니다.</h5>
        <img id="Toilet" class="centered" src="<%=cp%>../../../img/Toilet/126.png" border="0" width="100%" usemap="#ToiletMap">
