...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
            <img class="center" id="103" src="<%=cp%>../../../img/Area/103.PNG" border="0" width="100%" usemap="#Area103">
            <map name = "Area103">
                <area id="ri103f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="103f" data-toggle="modal" onclick="getId('ri103f')">
                <area id="ri103m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="103m" data-toggle="modal" onclick="getId('ri103m')">
                <area id="103r" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="103r" data-toggle="modal" onclick="getId('103r')">
            </map>
        </p>
    </section>
    <section id="content2">
