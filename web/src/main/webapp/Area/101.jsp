...
<main>
    ...
    <map name = "Area101">
        ...
        <area id="101r" shape="poly" coords="3,430,3,563,9,584,14,595,26,610,41,621,68,630,426,630,454,624,478,604,490,581,495,560,495,430" href="#VRModal" alt="101r" data-toggle="modal" onclick="getId('101r')">
    </map>
    </p>
    </section>
    <section id="content2">
