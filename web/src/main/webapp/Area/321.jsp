...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="321" class="centered" src="<%=cp%>../../../img/Area/321.PNG" border="0" width="100%" usemap="#Area321" >
        <map name = "Area321">
            <area id="321f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="321f" data-toggle="modal" onclick="getId('321f')">
            <area id="321m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt=321m" data-toggle="modal" onclick="getId('321m')">
            <area id="321r" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="321r" data-toggle="modal" onclick="getId('321r')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <h5 class="centered" style="color: grey">321구역은 화살표가 가르치는 출구를 통해 나가셔서 2층 화장실을 이용하시기를 추천합니다.</h5>
