...
<%String cp = request.getContextPath();
    session.setAttribute("Area","outfield_grass7");%>
<html>
<head>
    <meta charset="utf-8">
...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="outfield_grass" class="centered" src="<%=cp%>../../../img/Area/outfield_grass.png" border="0" width="100%" usemap="#outfield_grass7" >
        <map name = "outfield_grass7">
            <area id="rioutfield_grass7f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="outfield_grass7" data-toggle="modal" onclick="getId('rioutfield_grass7f')">
            <area id="rioutfield_grass7m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="outfield_grass7" data-toggle="modal" onclick="getId('rioutfield_grass7m')">
            <area id="outfield_grass7r" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="outfield_grass7" data-toggle="modal" onclick="getId('outfield_grass7r')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <img id="Toilet" class="centered" src="<%=cp%>../../../img/Toilet/outfield_grass4.png" border="0" width="100%" usemap="#ToiletMap">
