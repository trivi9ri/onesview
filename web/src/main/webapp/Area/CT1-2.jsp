...
<%String cp = request.getContextPath();
    session.setAttribute("Area","CT1-2");%>
<html>
<head>
    <meta charset="utf-8">
...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="CT1-2" class="centered" src="<%=cp%>../../../img/Area/CT1-2.png" border="0" width="100%" usemap="#AreaCT1-2" >
        <map name = "AreaCT1-2">
            <area id="CT1-1r" shape="poly" coords="43,1,27,5,16,13,8,24,2,39,2,306,9,324,27,339,38,344,231,344,253,334,264,323,270,305,270,41,258,16,241,5,232,1" href="#VRModal" alt="CT1-2" data-toggle="modal" onclick="getId('CT1-1r')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <h5 class="centered" style="color: grey">지니존은 출구(파란원)를 통해 나가셔서 2층 화장실을 이용하시기를 추천합니다.</h5>
        <img id="Toilet" class="centered" src="<%=cp%>../../../img/Toilet/CT1.png" border="0" width="100%" usemap="#ToiletMap">
