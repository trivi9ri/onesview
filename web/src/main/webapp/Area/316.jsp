...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="316" class="centered" src="<%=cp%>../../../img/Area/316.png" border="0" width="100%" usemap="#Area316" >
        <map name = "Area316">
            <area id="ri316f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="316f" data-toggle="modal" onclick="getId('ri316f')">
            <area id="ri316m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="316m" data-toggle="modal" onclick="getId('ri316m')">
            <area id="ri316r" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="316r" data-toggle="modal" onclick="getId('ri316r')">
        </map>
        </p>
    </section>
