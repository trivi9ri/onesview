...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="BBQ" class="centered" src="<%=cp%>../../../img/Area/BBQ.png" border="0" width="100%" usemap="#AreaBBQ" >
        <map name = "AreaBBQ">
            <area id="riBBQf" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="BBQf" data-toggle="modal" onclick="getId('riBBQf')">
            <area id="BBQm" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="BBQm" data-toggle="modal" onclick="getId('BBQm')">
            <area id="BBQr" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="BBQr" data-toggle="modal" onclick="getId('BBQr')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <h5 class="centered" style="color: grey">BBQ석은 화살표가 가르치는 출구를 통해 나가셔서 1층 화장실을 이용하시기를 추천합니다.</h5>
