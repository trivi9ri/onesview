...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="220" class="centered" src="<%=cp%>../../../img/Area/220.png" border="0" width="100%" usemap="#Area220" >
        <map name = "Area220">
            <area id="ri220f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="220f" data-toggle="modal" onclick="getId('ri220f')">
            <area id="220m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="220m" data-toggle="modal" onclick="getId('ri220m')">
            <area id="220r" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="220r" data-toggle="modal" onclick="getId('220r')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <h5 class="centered" style="color: grey">220구역은 출입구(파란 원)을 통해 2층 화장실을 이용하시기를 추천합니다.</h5>
