...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="209" class="centered" src="<%=cp%>../../../img/Area/209.PNG" border="0" width="100%" usemap="#Area209" >
        <map name = "Area209">
            <area id="ri209f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="209f" data-toggle="modal" onclick="getId('ri209f')">
            <area id="209m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="209m" data-toggle="modal" onclick="getId('ri209m')">
            <area id="209r" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="209r" data-toggle="modal" onclick="getId('209r')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <h5 class="centered" style="color: grey">209구역은 화살표가 가르치는 출구를 통해 나가셔서 2층 화장실을 이용하시기를 추천합니다.</h5>
        <img id="Toilet" class="centered" src="<%=cp%>../../../img/Toilet/209.png" border="0" width="100%" usemap="#ToiletMap">
