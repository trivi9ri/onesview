...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="403" class="centered" src="<%=cp%>../../../img/Area/403.png" border="0" width="100%" usemap="#Area403" >
        <map name = "Area403">
            <area id="ri403" shape="poly" coords="43,1,27,5,16,13,8,24,2,39,2,306,9,324,27,339,38,344,231,344,253,334,264,323,270,305,270,41,258,16,241,5,232,1" href="#VRModal" alt="403" data-toggle="modal" onclick="getId('ri403')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <h5 class="centered" style="color: grey">403구역은 화살표가 가르치는 출구를 통해 나가셔서 4층 화장실을 이용하시기를 추천합니다.</h5>
        <img id="Toilet" class="centered" src="<%=cp%>../../../img/Toilet/403.png" border="0" width="100%" usemap="#ToiletMap">
