...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="outfield" class="centered" src="<%=cp%>../../../img/Area/outfield.png" border="0" width="100%" usemap="#outfield2" >
        <map name = "outfield2">
            <area id="outfield2f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="outfield2f" data-toggle="modal" onclick="getId('outfield2f')">
            <area id="outfield2m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="outfield2m" data-toggle="modal" onclick="getId('outfield2m')">
            <area id="outfield2r" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="outfield2r" data-toggle="modal" onclick="getId('outfield2r')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <img id="Toilet" class="centered" src="<%=cp%>../../../img/Toilet/outfield.png" border="0" width="100%" usemap="#ToiletMap">
