...
<%String cp = request.getContextPath();
    session.setAttribute("Area","CT1-1");%>
<html>
<head>
    <meta charset="utf-8">
...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="CT1-1" class="centered" src="<%=cp%>../../../img/Area/CT1-1.png" border="0" width="100%" usemap="#AreaCT1-1" >
        <map name = "AreaCT1-1">
            <area id="CT1-1r" shape="poly" coords="43,1,27,5,16,13,8,24,2,39,2,306,9,324,27,339,38,344,231,344,253,334,264,323,270,305,270,41,258,16,241,5,232,1" href="#VRModal" alt="423" data-toggle="modal" onclick="getId('CT1-1r')">
        </map>
        </p>
    </section>
