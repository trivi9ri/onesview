...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="319" class="centered" src="<%=cp%>../../../img/Area/319.png" border="0" width="100%" usemap="#Area319" >
        <map name = "Area319">
            <area id="ri319f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="319f" data-toggle="modal" onclick="getId('ri319f')">
            <area id="ri319m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="319m" data-toggle="modal" onclick="getId('ri319m')">
            <area id="ri319r" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="319r" data-toggle="modal" onclick="getId('ri319r')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <h5 class="centered" style="color: grey">319구역은 출구(파란 원)를 통해 나가셔서 2층 화장실을 이용하시기를 추천합니다.</h5>
