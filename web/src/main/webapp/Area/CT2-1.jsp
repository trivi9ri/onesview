...
<%String cp = request.getContextPath();
    session.setAttribute("Area","CT2-1");%>
<html>
<head>
    <meta charset="utf-8">
    ...
    <title>BC라운지존(CT2-1) Block</title>
...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="CT2-1" class="centered" src="<%=cp%>../../../img/Area/CT2-1.png" border="0" width="100%" usemap="#AreaCT2-1" >
        <map name = "AreaCT2-1">
            <area id="CT2-1r" shape="poly" coords="43,1,27,5,16,13,8,24,2,39,2,306,9,324,27,339,38,344,231,344,253,334,264,323,270,305,270,41,258,16,241,5,232,1" href="#VRModal" alt="CT2-1" data-toggle="modal" onclick="getId('CT2-1r')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <h5 class="centered" style="color: grey">BC라운지존은 출구(파란원)를 통해 나가셔서 2층 화장실을 이용하시기를 추천합니다.</h5>
        <img id="Toilet" class="centered" src="<%=cp%>../../../img/Toilet/CT2.png" border="0" width="100%" usemap="#ToiletMap">
