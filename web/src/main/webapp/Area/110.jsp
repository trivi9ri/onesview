...
<main>
    ...
    <section id = "content1">
        <p>
            <img id="110" src="<%=cp%>../../../img/Area/110.PNG" width="500" height ="635" usemap="#Area110" alt>
            <map name = "Area110">
                <area id="ri110f" shape="poly" coords="77,5,55,11,39,17,21,36,8,59,3,79,3,192,495,192,495,77,486,51,480,42,465,21,443,10,422,5" href="#VRModal" alt="110f" data-toggle="modal" onclick="getId('ri110f')">
                <area id="ri110m" shape="poly" coords="3,210,495,210,495,410,3,410" href="#VRModal" alt="110m" data-toggle="modal" onclick="getId('ri110m')">
                <area id="ri110r" shape="poly" coords="3,430,3,563,9,584,14,595,26,610,41,621,68,630,426,630,454,624,478,604,490,581,495,560,495,430" href="#VRModal" alt="110r" data-toggle="modal" onclick="getId('ri110r')">
            </map>
        </p>
    </section>
    <section id="content2">
