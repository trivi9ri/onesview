...
<main>
    ...
    <section id = "content1">
        <p>
            <img id="106" src="<%=cp%>../../../img/Area/106.PNG" width="500" height ="635" usemap="#Area106" alt>
            <map name = "Area106">
                <area id="ri106f" shape="poly" coords="77,5,55,11,39,17,21,36,8,59,3,79,3,192,495,192,495,77,486,51,480,42,465,21,443,10,422,5" href="#VRModal" alt="106f" data-toggle="modal" onclick="getId('ri106f')">
                <area id="ri106m" shape="poly" coords="3,210,495,210,495,410,3,410" href="#VRModal" alt="106m" data-toggle="modal" onclick="getId('ri106m')">
                <area id="106r" shape="poly" coords="3,430,3,563,9,584,14,595,26,610,41,621,68,630,426,630,454,624,478,604,490,581,495,560,495,430" href="#VRModal" alt="106r" data-toggle="modal" onclick="getId('106r')">
            </map>
        </p>
    </section>
    <section id="content2">
