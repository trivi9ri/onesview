...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="222" class="centered" src="<%=cp%>../../../img/Area/222.png" border="0" width="100%" usemap="#Area222" >
        <map name = "Area222">
            <area id="ri222f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="222f" data-toggle="modal" onclick="getId('ri222f')">
            <area id="ri222m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="222m" data-toggle="modal" onclick="getId('ri222m')">
            <area id="222r" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="222r" data-toggle="modal" onclick="getId('222r')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <h5 class="centered" style="color: grey">222구역은 출입구(파란 원)을 통해 2층 화장실을 이용하시길 추천합니다.</h5>
