...
<%String cp = request.getContextPath();
    session.setAttribute("Area","outfield_grass6");%>
<html>
<head>
    <meta charset="utf-8">
...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="outfield_grass" class="centered" src="<%=cp%>../../../img/Area/outfield_grass.png" border="0" width="100%" usemap="#outfield_grass6" >
        <map name = "outfield_grass6">
            <area id="rioutfield_grass6f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="outfield_grass6" data-toggle="modal" onclick="getId('rioutfield_grass6f')">
            <area id="rioutfield_grass6m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="outfield_grass6" data-toggle="modal" onclick="getId('rioutfield_grass6m')">
            <area id="outfield_grass6r" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="outfield_grass6" data-toggle="modal" onclick="getId('outfield_grass6r')">
        </map>
        </p>
    </section>
    ...
    <section id="content4">
        ...
        <h5 class="centered" style="color: grey">외야자유석(잔디존)은 화살표가 가르치는 출구를 통해 나가셔서 1층 화장실을 이용하시기를 추천합니다.</h5>
        <img id="Toilet" class="centered" src="<%=cp%>../../../img/Toilet/outfield_grass3.png" border="0" width="100%" usemap="#ToiletMap">
