...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="213" class="centered" src="<%=cp%>../../../img/Area/213.png" border="0" width="100%" usemap="#Area213" >
        <map name = "Area213">
            <area id="ri213f" shape="poly" coords="40,1,23,6,8,21,1,39,1,100,271,100,271,39,263,20,252,10,231,1" href="#VRModal" alt="213f" data-toggle="modal" onclick="getId('ri213f')">
            <area id="213m" shape="poly" coords="1,110,271,110,271,210,1,210" href="#VRModal" alt="213m" data-toggle="modal" onclick="getId('ri213m')">
            <area id="ri213r" shape="poly" coords="1,220,1,306,9,326,20,337,38,343,234,343,256,332,265,321,272,305,272,220" href="#VRModal" alt="213r" data-toggle="modal" onclick="getId('ri213r')">
        </map>
        </p>
    </section>
