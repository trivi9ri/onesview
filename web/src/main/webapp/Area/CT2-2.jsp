...
<%String cp = request.getContextPath();
    session.setAttribute("Area","CT2-2");%>
<html>
<head>
    <meta charset="utf-8">
    ...
    <title>BC라운지존(CT2-2) Block</title>
...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="CT2-2" class="centered" src="<%=cp%>../../../img/Area/CT2-2.png" border="0" width="100%" usemap="#AreaCT2-2" >
        <map name = "AreaCT2-2">
            <area id="CT2-1r" shape="poly" coords="43,1,27,5,16,13,8,24,2,39,2,306,9,324,27,339,38,344,231,344,253,334,264,323,270,305,270,41,258,16,241,5,232,1" href="#VRModal" alt="CT2-2" data-toggle="modal" onclick="getId('CT2-1r')">
        </map>
        </p>
    </section>
