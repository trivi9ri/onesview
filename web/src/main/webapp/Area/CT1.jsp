...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="CT1" class="centered" src="<%=cp%>../../../img/Area/CT1.png" border="0" width="100%" usemap="#AreaCT1" >
        <map name = "AreaCT1">
            <area id="riCT1" shape="poly" coords="43,1,27,5,16,13,8,24,2,39,2,306,9,324,27,339,38,344,231,344,253,334,264,323,270,305,270,41,258,16,241,5,232,1" href="#VRModal" alt="riCT1" data-toggle="modal" onclick="getId('riCT1')">
        </map>
        </p>
    </section>
