...
<%String cp = request.getContextPath();
    session.setAttribute("Area","outfield_grass4");%>
<html>
<head>
    <meta charset="utf-8">
...
<main>
    ...
    <section id = "content1">
        ...
        <br/>
        <img id="outfield_grass" class="centered" src="<%=cp%>../../../img/Area/outfield_grass.png" border="0" width="100%" usemap="#outfield_grass4" >
        <map name = "outfield_grass4">
            <area id="outfield_grass4r" shape="poly" coords="43,1,27,5,16,13,8,24,2,39,2,306,9,324,27,339,38,344,231,344,253,334,264,323,270,305,270,41,258,16,241,5,232,1" href="#VRModal" alt="outfield_grass4" data-toggle="modal" onclick="getId('outfield_grass4r')">
        </map>
        </p>
    </section>
